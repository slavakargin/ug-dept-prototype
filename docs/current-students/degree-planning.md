...
- Goals: grad school, teaching, industry, double major/minor, study abroad, etc.
...
- leave room for GenEd / second major/minor
...
## Step 4: Review once per semester
Update your plan each semester after registration:
- adjust for course availability
- check progress in DegreeWorks
- confirm remaining requirements with advising if anything is unclear

## Practical experience (where applicable)
Some tracks encourage or require a practical experience (internship, research, consulting course).
- How to satisfy/verify: (add link or brief guidance)
